...
import json
import numpy as np
from src.data_preprocessing import load_data, train_test_split
...
def main():
    ...
    lr = 0.01
    epochs = 100
    lambda_ = 0.01  # avoid conflict with Python keyword

    params = {"lr": lr, "epochs": epochs, "lambda": lambda_}
    ...
    with open(log_params_path, "w", encoding="utf-8") as file_handle:
